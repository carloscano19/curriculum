...
export function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-white/90 backdrop-blur-md shadow-sm py-2 md:py-4" : "bg-transparent py-4 md:py-6"
        }`}
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        <a href="#" className="shrink-0 mr-8 flex items-center">
          <img
            ...
            alt="Logo CCF"
            className="h-12 md:h-20 w-auto object-contain hover:opacity-80 transition-opacity"
          />
        </a>
